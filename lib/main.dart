...
import 'package:life_os_productivity/features/dashboard/presentation/pages/splash_screen_page.dart';
...
void main() async {
  try {
    ...
    // In production, we at least want to show the app shell
    // instead of a black screen if something minor fails.
...
void _registerAdapters() {
  ...
  if (!Hive.isAdapterRegistered(10)) Hive.registerAdapter(UserProfileModelAdapter());
  if (!Hive.isAdapterRegistered(11)) Hive.registerAdapter(CategoryModelAdapter());
}
